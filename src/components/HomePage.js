...
function HomePage() {
    ...
    return (
        <div className="h-screen bg-ocean bg-cover flex justify-center items-center">
            <div className='h-[80%] w-[80%] flex'>
                ...
                <div className='w-full relative'>
                    <div className='h-[90%] bg-gray-500 px-4 py-2 opacity-60 space-y-2'>
                        {!param ? messageList.map((msg, index) => {
                            return <Message key={index} message={msg} />
                        }) : bookmarkList.map((bookmark, index) => {
                            return <Message key={index} message={bookmark} />
                        })
                        }
                    </div>
